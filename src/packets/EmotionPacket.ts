...
export class EmotionPacket {
    public static loadEmotions(): Packet {
        ...
        const emoteList = [
            90200011, 90200004, 90200024, 90200041, 90200042, 90200057, 90200043, 90200022, 90200031, 90200005,
            90200006, 90200003, 90200092, 90200077, 90200073, 90200023, 90200001, 90200019, 90200020, 90200021,
